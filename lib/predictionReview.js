  ...
  for (const bout of cardRows) {
    ...
    cardMatrix.push({
      ...
      red: {
        id: bout.red_id,
        name: bout.red_name,
        headshot_url: bout.red_headshot_url || (red && red.headshot_url) || null,
        body_url: bout.red_body_url || (red && red.body_url) || null,
      ...
      blue: {
        id: bout.blue_id,
        name: bout.blue_name,
        headshot_url: bout.blue_headshot_url || (blue && blue.headshot_url) || null,
        body_url: bout.blue_body_url || (blue && blue.body_url) || null,
